tags$section(id = "overview",
 ...
 absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
  ...
  h6("A Visualisation by FitzFritzData", tags$a(href="https://twitter.com/fitzfritzdata", icon("twitter")), tags$a(href="https://www.linkedin.com/in/pascal-frick/", icon("linkedin"), icon("github")),
